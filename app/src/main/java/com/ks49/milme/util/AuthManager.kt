...
/**
 * This class handles all Authentication functions for the app. There are a few restrictions with
 * respect to when functions in this app can be called, make sure you read the comments on each
 * function!
 *
 * **/

// TODO-AGM: Need to use dependency injection to inject, FirebaseAuth, and Activity.
class AuthManager(
    ...
    // TODO-AGM: Isn't there a way to resolve the calling activity without relying on it as a
    //  Parameter for AuthManager?
    /**
